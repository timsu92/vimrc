...
let g:coc_global_extensions = ['coc-json', 'coc-clangd', 'coc-cmake', 'coc-highlight', 'coc-html', 'coc-sh', 'coc-vimlsp', 'coc-pairs', 'coc-omni', 'coc-word', 'coc-snippets', 'coc-markdownlint', 'coc-spell-checker', 'coc-lightbulb', 'coc-pyright', '@yaegassy/coc-volar', '@yaegassy/coc-volar-tools', '@yaegassy/coc-tailwindcss3', 'coc-pydocstring']
set hidden
